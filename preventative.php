...
foreach($resultss as $data)
{   
  $month[] = htmlentities($data->x);
   $amount[] = htmlentities($data->y);
 }
...
<td><b>S/N</b></td>
<td><b>Month</b></td>
<td><b>No. of Preventatives Recorded</b></td>
</tr>
<?php
// code Student Data
...
<tr>
<td> <small><?php echo htmlentities($cnt);?></small></td>
...
<?php $cnt=$cnt+1;}}
    ...
    <td><b><?php echo $total1;?></b></td>
	 	...
	 	<div style="width:65%; float:right; margin-left:20px;">
  <canvas id="myChart"></canvas>
        ...
        <script>
            $(function(){
                ...
                toastr["success"]( "Welcome HSE Assurance Management System!");
